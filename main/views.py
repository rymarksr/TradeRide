...
def main_view(request):
    return render(request, "views/main.html", {"name": "Rymark Recaplaza"})
...
def inquire_listing_using_email(request, id):
    ...
    try:
        ...
        emailMessage = f'Hi {listing.seller.user.username}, {request.user.username} is interested in your {listing.model} listing on TradeRide'
        send_mail(emailSubject, emailMessage, 'noreply@traderide.com',
